...
// router.post('/authenticated/addShowToWatchlist', listController.addShowToWatchlist)
// router.post('/authenticated/removeShowFromWatchlist', listController.removeShowFromWatchlist)
